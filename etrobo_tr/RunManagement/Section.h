...
private:
    ...
    // 前進量リスト
    float m_forward_list[15] = {110, 120, 120, 110, 100, 90, 100, 100, 100, 110, 95, 90, 85, 100, 120};
    ...
    float m_distance_list[15] = {0.60, 1.25, 1.70, 2.45, 3.30, 4.00, 4.60, 4.70, 5.55, 6.45, 7.00, 7.05, 7.60, 8.95, 9.25};
